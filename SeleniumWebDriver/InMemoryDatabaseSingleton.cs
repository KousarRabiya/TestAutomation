...
using System;
using SeleniumWebDriver.DataTransferObjects;
...
namespace SeleniumWebDriver
{
    internal class InMemoryDatabaseSingleton
    {
        ...
        private InMemoryDatabaseSingleton()
        {
            ...
            switch (AppConfigReader.ApplicationTestEnvironment.ToUpper())
            {
                case "COMETDEV":
                    this.DeserializeTheXmlDataInMemory(GetInMemoryTestDataFilePath
       (AppConfigReader.ApplicationTestEnvironment)); break;
                case "COMETUAT":
                    this.DeserializeTheXmlDataInMemory(GetInMemoryTestDataFilePath
       (AppConfigReader.ApplicationTestEnvironment)); break;
                case "ROLCERT":
        ...
        private String GetInMemoryTestDataFilePath(string applicationEnvironment)
        {
            ...
            + "\\..\\..\\..\\Repos\\TestAutomation\\SeleniumWebDriver\\InMemoryTestData\\TestData"
