...
namespace SeleniumWebDriver
{
    ...
    {
        private const string ENV_AUTOMATION_REMOTE = "AUTOMATION_IS_REMOTE";
        private const string ENV_AUTOMATION_BROWSER = "AUTOMATION_BROWSER";
        private const string ENV_AUTOMATION_REMOTE_HUB_URL = "AUTOMATION_REMOTE_HUB_URL";
        private const string ENV_AUTOMATION_TEST_ENVIRONMENT_NAME = "AUTOMATION_TEST_ENVIRONMENT";
        ...
        {
            Console.Out.WriteLine(string.Format("Attempting to get ENV_AUTOMATION_REMOTE"));
            bool success = Boolean.TryParse(Environment.GetEnvironmentVariable(ENV_AUTOMATION_REMOTE), out _isRemote);
            if (!success)
            {
            ...
            _browserName = Environment.GetEnvironmentVariable(ENV_AUTOMATION_BROWSER);
            ...
            Console.Out.WriteLine(string.Format("Attempting to get ENV_AUTOMATION_TEST_ENVIRONMENT"));
            _applicationTestEnvironmentName = Environment.GetEnvironmentVariable(ENV_AUTOMATION_TEST_ENVIRONMENT_NAME);
            ...
            if (_isRemote)
            {
                Console.Out.WriteLine(string.Format("Attempting to get ENV_AUTOMATION_REMOTE_HUB_URL"));
                _remoteHubUrl = Environment.GetEnvironmentVariable(ENV_AUTOMATION_REMOTE_HUB_URL);
        ...
        public static IWebDriver GetInstance()
        {
            ...
            if (_isRemote)
            {
                ...
                switch (_browserName)
                {
                    ...
                    case BaseTestFixture.InternetExplorer: remoteCapability = DesiredCapabilities.InternetExplorer(); break;
                    case BaseTestFixture.FireFox: remoteCapability = DesiredCapabilities.Firefox(); break;
                    case BaseTestFixture.Safari: remoteCapability = DesiredCapabilities.Safari(); break;
                    case BaseTestFixture.Chrome:
                        var chromeOptions = new ChromeOptions();
                        chromeOptions.AddArgument("disable-popup-blocking");
                        remoteCapability = (DesiredCapabilities)chromeOptions.ToCapabilities();
                        break;
                    case BaseTestFixture.Edge: remoteCapability = DesiredCapabilities.Edge(); break;
        ...
        private static IWebDriver FireFoxWebDriver()
        {
            ...
            profile.SetPreference("browser.download.dir", AppConfigReader.DownloadFilePath.Replace("file:\\", ""));
            profile.SetPreference("services.sync.prefs.sync.browser.download.manager.showWhenStarting", false);
            profile.SetPreference("browser.download.useDownloadDir", true);
            profile.SetPreference("browser.download.downloadDir", AppConfigReader.DownloadFilePath.Replace("file:\\", ""));
            profile.SetPreference("browser.download.defaultFolder", AppConfigReader.DownloadFilePath.Replace("file:\\", ""));
        ...
        private static IWebDriver ChromeWebDriver()
        {
            ...
            chromeOptions.AddUserProfilePreference("download.default_directory", AppConfigReader.DownloadFilePath.Replace("file:\\", ""));
            // chrome driver path
        ...
        public static IWebDriver GetBrowserInstance(string browser)
        {
            ...
            if (_isRemote)
            {
                ...
                //    // get browser driver based on browserName
                //    case ""InternetExplorer = internetExplorerOptions; break;
                //    case BaseTestFixture.FireFox: remoteCapability = firefoxOptions; break;
                //    case BaseTestFixture.Safari: remoteCapability = DesiredCapabilities.Safari(); break;
                //    case BaseTestFixture.Chrome: remoteCapability = DesiredCapabilities.Chrome(); break;
                //    case BaseTestFixture.Edge: remoteCapability = DesiredCapabilities.Edge(); break;
                //    default: throw new ArgumentException("The suggested browser was not found");
                //}
                // object representing the image of the page on the screen
