...
namespace SeleniumWebdriver.ComponentHelper
{
    public class GenericHelper
    {
        ...
        {
            return Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location).Replace("\\bin\\Debug", "");
        }
        public static string CurrentDirectory()
        {
            string path= Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location).Replace("\\bin\\Debug", "");
