...
namespace CometProject.FeatureFile
{
    ...
    [NUnit.Framework.DescriptionAttribute("CometSearchFeature")]
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "CometSearchFeature", "\tGets Comet search parameters from Database", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("Search with Employee Number")]
        public virtual void SearchWithEmployeeNumber()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Search with Employee Number", ((string[])(null)));
#line 4
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Search with Employer Code")]
